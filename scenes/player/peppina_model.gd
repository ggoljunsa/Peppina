...
@export_range(0, 20, 1) var face_var: int = 0  #얼 모양 인덱스
@export var face_grid_size: int = 13  # 8x8 그리드 크기
...
func _process(delta: float) -> void:
	...
	material_face.set_shader_parameter('_MainTex_ST', Vector4(face_uv_size.x,face_uv_size.y,(1.0/face_grid_size) *face_var, 0))
